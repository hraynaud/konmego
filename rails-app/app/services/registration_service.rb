class RegistrationService
  class << self
    ...
    def confirm(id, code, password, invite_code = nil)
      ...
      raise 'Invalid confirmation credentials' unless person && confirmationValid?(person, code, password)
    ...
    def build_registration(params)
      registrant = PersonService.build(params)
